...
inputDir="/Volumes/Lab_Group/BoltonFCS/SophiaMykhaloR1R2/T034"
...
for file in "${inputDir}"/*R1*fastq.gz ; do
	...
	mkdir -p /Volumes/Lab_Group/BoltonFCS/SophiaMykhaloR1R2/ExcelOutputs/T034/${sample}
		...
		./chimFinder.py --pathogenR1 ${outputDir}_R1/tmp/alns/${sample}${baseEnd}.siv.bowtie.sam \
						...
						-o /Volumes/Lab_Group/BoltonFCS/SophiaMykhaloR1R2/ExcelOutputs/T034/${sample}${baseEnd}/${sample} \
						-t 12 \
						--minLen 20 \
						--maxLenUnmapped 30 \
						-a ${annotation} \
