...
#inputDir="/Volumes/Lab_Group/BoltonFCS/SophiaMykhaloR1R2/correctAY69"
inputDir="/Users/scheng/Downloads/chimFinder-master/trim"
#outputDir="/Users/scheng/Documents/test"
outputDir="/Volumes/Lab_Group/BoltonFCS/SophiaMykhaloR1R2/chimFinderoutput"
sivDB="/Users/scheng/Documents/chimFinderStuff/SIVr251/siv_reference_index"
...
for file in "${inputDir}"/*R1*fastq.gz ; do
	...
	mkdir -p /Volumes/Lab_Group/BoltonFCS/SophiaMykhaloR1R2/ExcelOutputs/AY69/${sample}
		...
		SECONDS=0
		echo CREATING REPORTS IN /Volumes/Lab_Group/BoltonFCS/SophiaMykhaloR1R2/ExcelOutputs/AY69/${sample}${baseEnd}/${sample}
		./chimFinder.py --pathogenR1 ${outputDir}_R1/tmp/alns/${sample}${baseEnd}.siv.bowtie.sam \
						...
						-o /Volumes/Lab_Group/BoltonFCS/SophiaMykhaloR1R2/ExcelOutputs/AY69/${sample}${baseEnd}/${sample} \
						-t 12 \
						--minLen 20 \
						--maxLenUnmapped 30 \
						-a ${annotation} \
